...
class SalesforceJarm():
    def __init__(self, input_ip):
        self.destination_host = input_ip
    ...
    def send_packet(self, packet):
        try:
            ...
            try:
                if (type(ipaddress.ip_address(self.destination_host)) == ipaddress.IPv4Address) or (type(ipaddress.ip_address(self.destination_host)) == ipaddress.IPv6Address):
                    raw_ip = True
